    ...
    return (
        <>
            <Paper sx={{
                ...
                {
                    currentStreak ?
                        <Typography variant="h3" fontWeight={'bold'} component={'h4'} align="center" marginBottom={'1rem'}>
                            {currentStreak}
                        </Typography>
                        : <Skeleton
                            variant="circular"
                            sx={{ display: 'block', height: '3.5rem', width: '3.5rem', textAlign: 'center', margin: '1rem auto' }}
                        />
                }
                {
                    nextMileStone ?
            ...
            {
                longestStreak ?
                    <Typography variant="body2" component={'p'} color={'GrayText'} align="left" sx={{ marginTop: '0.25rem !important' }}>
